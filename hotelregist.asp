...
<h2> Step 1. Check hotel id availability</h2>
<form method="post" action="hotelregist.asp">
<table>
<tr>
<td> Enter Userid</td><td><input type="text" name="t1"></td>
<td><input type="submit" value="check hotelid"></td>
</tr>
</table>
</form>
</div>
...
sql="select * from hotelreg where hotelid='"&request.form("t1")&"'"
rs.open sql,con
if rs.eof then
%>
<div style="position:absolute;left:10;top:160;width:400;">
<h2>Step 2. Enter Registration details</h2>
<form method="post" action="hotelregistration.asp">
<table>
<tr>
<td>Hotel id</td>
...
alert("hotelid already exists in the system Please try another Id")
</script>
<%
end if
rs.close
