...
<iframe src="socail.htm" scrolling="no" style="position:absolute;left:0;bottom:202;" height="600" width="200">
</iframe>

<div style="position:absolute;left:202;top:310;" height="500" width="998">
<% 
...
<tr>
<td><%response.write("User successfully registered in the system")%></td></tr>
<tr><td><%response.write("<br>Kindly note your user id :"&request.form("t2"))%></td></tr>
<tr><td><%response.write("<br><a href='ulogin.asp'>click here to login</a>")%></td></tr>
</table>
</div>
<%
rs.close
